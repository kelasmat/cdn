...
(function($){	
	...
	_lang = {
			ans:{	// _lang.ans are shown during the display of .q-result, the answer result.
				corrAns: "Jawaban yang benar:",
				praise: 'Jawaban Anda Benar!',
				retry: 'Salah.<br/>Silahkan coba jawaban lain.',
				whyAns: "Info:",
			...
			btn:{	// [ "text", "title" ]
				...
				del: [ "Hapus", "Hapus Test" ],
				help: [ "Bantuan", 'Klik untuk bantuan'],
				next: [ "Selanjutnya", "Pertanyaan Selanjutnya" ],
